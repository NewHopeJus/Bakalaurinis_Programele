...
public class LevelsData {
    ...
    public LevelsData() {
        ...
        levels.add(new Level("2 lygis", Arrays.asList("Natūralieji, sveikieji ir trupmeniniai skaičiai",
                "Plokščiosios figūros", "Figūrų plotai", "Tekstiniai uždaviniai", "Lygtys")));
        levels.add(new Level("3 lygis", Arrays.asList("Teigiami, neigiami, realieji skaičiai", "Laipsniai", "Lygtys",
