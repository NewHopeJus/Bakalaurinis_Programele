...
import com.mastercoding.bakalaurinis.databinding.FragmentManoPilisBinding;
...
public class ManoPilisFragment extends Fragment {
    private FragmentManoPilisBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentManoPilisBinding.inflate(inflater, container, false);
